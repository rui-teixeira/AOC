...
def solve(arr,i,acc,op,target, last_i):
    ...
    if op == '+':
        ...
        # just starting
        return solve(arr, i+1, arr[0], '+', target, last_i) or solve(arr, i+1, arr[0], '*', target, last_i)
    ...
    return solve(arr, i+1, new_acc, '+', target, last_i) or solve(arr, i+1, new_acc, '*', target, last_i)
